...
do
  ...
  do
    ...
    case "$choosen_function" in
      "1" ) exec $HOME/.panel/www/root_www_add.sh;;
      "2" ) exec $HOME/.panel/www/root_www_delete.sh;;
      "3" ) exec $HOME/.panel/www/root_www_edit.sh;;
      "4" ) exec $HOME/.panel/root_panel_start.sh;;
      * ) if [ $wrong_count = "2" ]
          then
