...
do
  ...
  do
    ...
    case "$choosen_function" in
      "1" ) exec $HOME/.panel/db/root_add_db.sh;;
      "2" ) exec $HOME/.panel/db/root_delete_db.sh;;
      "3" ) exec $HOME/.panel/db/root_add_db_user.sh;;
      "4" ) exec $HOME/.panel/db/root_delete_db_user.sh;;
      "5" ) exec $HOME/.panel/db/root_add_user_to_db.sh;;
      "6" ) exec $HOME/.panel/db/root_delete_user_from_db.sh;;
      "7" ) exec $HOME/.panel/root_panel_start.sh;;
      * ) if [ $wrong_count = "2" ]
          then
