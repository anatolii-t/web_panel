...
do
  ...
  do
    ...
    case "$choosen_function" in
      "1" ) exec $HOME/.panel/account/admin_add_user_account.sh;;
      "2" ) exec $HOME/.panel/account/admin_delete_user_account.sh;;
      "3" ) exec $HOME/.panel/account/admin_delete_self_account.sh;;
